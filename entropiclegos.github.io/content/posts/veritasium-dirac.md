...
### Interpreting negative-energy solutions of Dirac
Derek and his team nearly traced out the entire interpretation of the negative-energy solutions, but in my opinion should have made the following point clearer. Dirac of course cleverly proposed that all the negative energy states are already occupied by electrons in what's often called the Dirac sea, and Veritasium beautifully shows how an antiparticle arises in this context as a *hole* in the Dirac sea - an absence of the negative-energy electron. If you take away a packet of negative energy from the vacuum, you leave it with *positive* energy, since $0 - (-E) = +E$. So strictly speaking, the negative-energy solutions on their own aren't the antiparticles in the Dirac theory - it's the hole left by them in the negative-energy states, which themselves have *positive-energy*. (The modern field theoretic interpretation is a little different, but maybe we'll talk about it another time.)
...
3. At a mathematically slightly more advanced (yet remarkably readable) level, *lecture notes by Dr. Matthias Lienert*. For something a bit more fleshed out physically, I used an old text called *Relativistic Quantum Mechanics: Wave Equations* by *W. Greiner* because I managed to find an old copy at a cheap price. There's also the legendary *Freeman Dyson lecture notes* on advanced QM that covers the Dirac equation at length. Amongst modern resources, I've used *Maiani & Benhar's* open access book *Relativistic Quantum Mechanics*, and some chapters from *Srednicki's QFT*, also available for free (an early but more or less complete draft) on his website.
